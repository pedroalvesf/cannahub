...
export const sampleAssociations: Association[] = [
  ...
  },
  {
    ...
    about: 'A AMME Medicinal é uma associação de pacientes fundada em 2019 em Recife, Pernambuco, dedicada a fornecer acesso seguro e legal a derivados de cannabis medicinal de alta qualidade.\n\nPossui um dos catálogos mais completos entre as associações brasileiras, com óleos CBD em 7 concentrações (de 10mg/ml a 100mg/ml), óleos THC em 6 concentrações, óleos mistos 1:1 e fórmulas exclusivas com canabinoides menores como CBN (canabinoide) e CBG (canabigerol).\n\nTodos os óleos são produzidos em veículo TCM (triglicerídeos de cadeia média) com aproximadamente 27 gotas por ml, garantindo precisão na dosagem. A associação conta com equipe de atendimento dedicada para orientação de pacientes e prescritores.',
    city: 'Recife', state: 'PE', region: 'Nordeste',
    patientTypes: ['Adulto', 'Responsável Legal', 'Médico/Veterinário'],
    productTypes: ['Óleo'],
    assistedAccess: false,
    memberCount: 200, foundedYear: 2019, verified: true,
